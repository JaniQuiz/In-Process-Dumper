...
| `dump_key`                         | `IDP_DUMP_KEY`                         | [Virtual key code](https://learn.microsoft.com/en-us/windows/win32/inputdev/virtual-key-codes) press to wait for before writing dump output.                                                                                                                                                                                                                                                                                                                                                      |
...
The dump key implementation is based on [Dumper-7](https://github.com/Encryqed/Dumper-7)